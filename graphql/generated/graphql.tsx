...
export type PostsQuery = (
  ...
  & { posts?: Maybe<Array<Maybe<(
    { __typename?: 'Post' }
    & Pick<Post, 'slug' | 'title' | 'description' | 'content'>
  )>>> }
);
 ...
 * });
 */
export function usePostsBySlugQuery(baseOptions?: Apollo.QueryHookOptions<PostsBySlugQuery, PostsBySlugQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<PostsBySlugQuery, PostsBySlugQueryVariables>(PostsBySlugDocument, options);
      }
export function usePostsBySlugLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<PostsBySlugQuery, PostsBySlugQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<PostsBySlugQuery, PostsBySlugQueryVariables>(PostsBySlugDocument, options);
        }
export type PostsBySlugQueryHookResult = ReturnType<typeof usePostsBySlugQuery>;
export type PostsBySlugLazyQueryHookResult = ReturnType<typeof usePostsBySlugLazyQuery>;
export type PostsBySlugQueryResult = Apollo.QueryResult<PostsBySlugQuery, PostsBySlugQueryVariables>;
